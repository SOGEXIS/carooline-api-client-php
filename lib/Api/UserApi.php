...
class UserApi
{
     ...
     * @return \Carooline\Model\MeResponse
     */
     ...
     * @throws \Carooline\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Carooline\Model\MeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function userMeGetWithHttpInfo()
    {
        $returnType = '\Carooline\Model\MeResponse';
