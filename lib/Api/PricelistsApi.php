...
class PricelistsApi
{
     ...
     */
    public function pricelistsGet($name = null)
    {
        list($response) = $this->pricelistsGetWithHttpInfo($name);
        return $response;
    }
     ...
     */
    public function pricelistsGetWithHttpInfo($name = null)
    {
        $returnType = '\Carooline\Model\PricelistSearchResponse';
        $request = $this->pricelistsGetRequest($name);
     ...
     */
    public function pricelistsGetAsync($name = null)
    {
        return $this->pricelistsGetAsyncWithHttpInfo($name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pricelistsGetAsyncWithHttpInfo($name = null)
    {
        $returnType = '\Carooline\Model\PricelistSearchResponse';
        $request = $this->pricelistsGetRequest($name);
     ...
     */
    protected function pricelistsGetRequest($name = null)
    {
