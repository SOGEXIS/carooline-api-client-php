...
class CategoriesApi
{
     ...
     */
    public function categoriesGet($name = null)
    {
        list($response) = $this->categoriesGetWithHttpInfo($name);
        return $response;
    }
     ...
     */
    public function categoriesGetWithHttpInfo($name = null)
    {
        $returnType = '\Carooline\Model\ProductCategorySearchResponse';
        $request = $this->categoriesGetRequest($name);
     ...
     */
    public function categoriesGetAsync($name = null)
    {
        return $this->categoriesGetAsyncWithHttpInfo($name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function categoriesGetAsyncWithHttpInfo($name = null)
    {
        $returnType = '\Carooline\Model\ProductCategorySearchResponse';
        $request = $this->categoriesGetRequest($name);
     ...
     */
    protected function categoriesGetRequest($name = null)
    {
