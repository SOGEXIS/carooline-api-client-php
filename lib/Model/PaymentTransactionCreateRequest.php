...
/**
 * PaymentTransactionCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  Carooline
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PaymentTransactionCreateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaymentTransactionCreateRequest';
...
self::STATE_CANCEL,        ];
    ...
    {
        $allowedValues = $this->getAcquirerAllowableValues();
        if (!in_array($acquirer, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'acquirer', must be one of '%s'",
                    implode("', '", $allowedValues)
