<?php
/**
 * SearchCategoriesForVehicleRequest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * SearchCategoriesForVehicleRequest Class Doc Comment
 *
 * @category Class
 * @package  Carooline
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SearchCategoriesForVehicleRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SearchCategoriesForVehicleRequest';
...
'add_not_tecdoc_categories' => 'bool',
'vehicle_query_type' => 'string'    ];
    ...
    protected static $swaggerFormats = [
        'parent_categ_id' => null,
'manufacturer_id' => null,
'vehicle_query' => null,
'add_not_tecdoc_categories' => null,
'vehicle_query_type' => null    ];
    ...
    protected static $attributeMap = [
        'parent_categ_id' => 'parent_categ_id',
'manufacturer_id' => 'manufacturer_id',
'vehicle_query' => 'vehicle_query',
'add_not_tecdoc_categories' => 'add_not_tecdoc_categories',
'vehicle_query_type' => 'vehicle_query_type'    ];
    ...
    protected static $setters = [
        'parent_categ_id' => 'setParentCategId',
'manufacturer_id' => 'setManufacturerId',
'vehicle_query' => 'setVehicleQuery',
'add_not_tecdoc_categories' => 'setAddNotTecdocCategories',
'vehicle_query_type' => 'setVehicleQueryType'    ];
    ...
    protected static $getters = [
        'parent_categ_id' => 'getParentCategId',
'manufacturer_id' => 'getManufacturerId',
'vehicle_query' => 'getVehicleQuery',
'add_not_tecdoc_categories' => 'getAddNotTecdocCategories',
...
self::VEHICLE_QUERY_TYPE_K_TYPE,        ];
    ...
    {
        $this->container['parent_categ_id'] = isset($data['parent_categ_id']) ? $data['parent_categ_id'] : null;
        ...
        $this->container['add_not_tecdoc_categories'] = isset($data['add_not_tecdoc_categories']) ? $data['add_not_tecdoc_categories'] : false;
    ...
    /**
     * Gets parent_categ_id
     *
     * @return int
     */
    public function getParentCategId()
    {
        return $this->container['parent_categ_id'];
    }

    /**
     * Sets parent_categ_id
     *
     * @param int $parent_categ_id parent_categ_id
     *
     * @return $this
     */
    public function setParentCategId($parent_categ_id)
    {
        $this->container['parent_categ_id'] = $parent_categ_id;
    ...
    /**
     * Gets add_not_tecdoc_categories
     *
     * @return bool
     */
    public function getAddNotTecdocCategories()
    {
        return $this->container['add_not_tecdoc_categories'];
    }

    /**
     * Sets add_not_tecdoc_categories
     *
     * @param bool $add_not_tecdoc_categories add_not_tecdoc_categories
     *
     * @return $this
     */
    public function setAddNotTecdocCategories($add_not_tecdoc_categories)
    {
        $this->container['add_not_tecdoc_categories'] = $add_not_tecdoc_categories;
